 ...
 * -- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
    Для описанной реализации алгоритма пирамидальной сортировки нужно выделить память под массив из |E| элементов. 
    То есть потребуется (помимо хранения графа, который нам нужно в любом случае хранить независимо от
    алгоритма) O(E) дополнительной памяти. 
 */
